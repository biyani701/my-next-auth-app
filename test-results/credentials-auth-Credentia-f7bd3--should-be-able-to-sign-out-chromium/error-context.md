...
- Name: Credentials Authentication for Testing >> should be able to sign out
- Location: C:\vishal\git-repo\next-auth-example\tests\credentials-auth.spec.js:48:3
...
Call log:
  - waiting for getByRole('link', { name: /sign in/i })
    ...
    at C:\vishal\git-repo\next-auth-example\tests\credentials-auth.spec.js:51:56
```
