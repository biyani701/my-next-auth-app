...
- Name: Keycloak Authentication >> should redirect to Keycloak login page when clicking the provider button
- Location: C:\vishal\git-repo\next-auth-example\tests\keycloak-auth.spec.js:23:3
...
============================================================
    at C:\vishal\git-repo\next-auth-example\tests\keycloak-auth.spec.js:33:12
```
